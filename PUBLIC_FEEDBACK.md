...
Thank you for testing Syllavox 0.4.0. This guide is for people trying the
...
- Syllavox version, normally `0.4.0`;
- Windows version;
...
The 0.4.0 release is a Windows portable MVP UI/UX, compatibility, privacy,
and optional Sherpa-ONNX backend release.
